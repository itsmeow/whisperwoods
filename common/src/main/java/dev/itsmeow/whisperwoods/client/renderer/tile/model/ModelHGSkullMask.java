...
public class ModelHGSkullMask<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public ModelHGSkullMask() {
        ...
        this.headSkull = new ModelPart(this, 98, 0);
        this.headSkull.setPos(0F, -7F, 1.3F);
        this.headSkull.addBox(-3.0F, -5.1F, -5.1F, 6.0F, 6.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.headSkull.xRot = (float) Math.toRadians(50F);
        ...
        this.headSkull.addChild(this.lAntler01);
        this.headSkull.addChild(this.rUpperJaw);
        ...
        this.headSkull.addChild(this.lUpperJaw);
        ...
        this.headSkull.addChild(this.snout);
