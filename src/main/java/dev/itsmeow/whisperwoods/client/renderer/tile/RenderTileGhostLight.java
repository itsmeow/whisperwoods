...
public class RenderTileGhostLight extends BlockEntityRenderer<TileEntityGhostLight> {
    ...
    @Override
    public void render(TileEntityGhostLight tileentity, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
                ...
                if(!Minecraft.getInstance().isPaused()) {
                    if(System.nanoTime() - tileentity.lastSpawn >= 100_000_000L) {
                        ...
                        if(block instanceof BlockWispLantern) {
                            ...
                            Direction dir = state.getValue(BlockWispLantern.FACING);
                            gYO = -0.35F;
                        ...
                        if(block instanceof BlockGhostLight && tileentity.getLevel() != null && tileentity.getBlockPos() != null && tileentity.getLevel().isLoaded(tileentity.getBlockPos().below())) {
