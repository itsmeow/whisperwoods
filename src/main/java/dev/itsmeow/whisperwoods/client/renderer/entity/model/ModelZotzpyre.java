...
public class ModelZotzpyre<T extends LivingEntity> extends EntityModel<T> {
    ...
    public void setRotationAngles(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        if(entity instanceof EntityZotzpyre) {
            ...
            this.neck.rotateAngleX = (entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * Minecraft.getInstance().getRenderPartialTicks()) * 0.017453292F;
            float yawOffset = interpolate(entity.prevRenderYawOffset, entity.renderYawOffset, Minecraft.getInstance().getRenderPartialTicks());
            float yawHead = interpolate(entity.prevRotationYawHead, entity.rotationYawHead, Minecraft.getInstance().getRenderPartialTicks());
            this.neck.rotateAngleY = (yawHead - yawOffset) * 0.017453292F;
        }
    }
